...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        DatabaseManger.shared.userExists(with: email) { [weak self] exists in
            ...
            guard !exists else {
                //user already exists
                strongSelf.alertUserLoginError(message: "Looks like a user account for that email address already exits.")
                return
            }
...
extension RegisterViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func presentPhotoActionSheet() {
        ...
        actionSheet.addAction(UIAlertAction(title: "Choose Photo from library", style: .default) { [weak self] _ in
